...
import com.example.serrano.grams.FingerprintAuthHelper;
...
public class FingerprintAuthHelper {
     ...
     * Private constructor.
     */
    private void FingerPrintAuthHelper(@NonNull Context context, @NonNull FingerPrintAuthCallback callback) {
        mCallback = callback;
        mContext = context;
    }
     ...
     * Private constructor.
     */
    private void FingerPrintAuthHelper() {
